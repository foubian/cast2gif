...
document.getElementById('file_selector').onchange = function (e) {
    ...
    //alert("aaa");
    document.getElementById('spinfile').style.visibility = 'hidden';
    document.getElementById('spinfileok').style.visibility = 'visible';
    enable_render_button(enabled);
};
document.getElementById('font').onchange = function (e) {
    document.getElementById('fontshow').style.fontFamily = this.value;
    PngGen();
};
document.getElementById('cursor').onchange = function (e) {
    PngGen();
};
document.getElementById('theme').onchange = function (e) {
    
    // alert(text.endsWith('light'));
    PngGen();
};
...
const ProgressSetter = function (delay = 200) {
    ...
    this.set = (percent) => {
        ...
        document.getElementById('progress').style.width= string + '%';
        document.getElementById('progress').innerText = string + '%';
        last_set_time = time;
    }
};
...
const ImgModal = function (parent) {
    ...
    span2.id = 'download';
    span2.innerHTML = '<i class="fa fa-download"></i>';
    ...
    span2.onclick = () => {
        download(SRC, "screengif.gif", "image/gif");
    };
...
document.getElementById('fontshow').style.fontFamily = 'monospace';
...
const PngGen = function () {
    ...
    const terminal = create_terminal_element();
    const text = document.getElementById('theme').value.replace(/_/g, ' ');
    ...
    png_renderer.onsuccess = function (data_url, width, height) {
        ...
        img.style.height = (height / 2).toString();
